...
const FooterLink = ({ href, children }) => (
  <Link
    to={`/${href}`}
    className="text-xs my-1 font-semibold lg:font-normal text-gray-300"
  >
    {children}
  </Link>
);
...
const footerCards = [
  {
    ...
    links: [
      ...
      {
        label: "How to shop on Store?",
        href: formatHref("How to shop on Store?"),
      },
      {
        label: "Delivery options and timelines",
        href: formatHref("Delivery options and timelines"),
      },
      {
        label: "How to return a product on Store?",
        href: formatHref("How to return a product on Store?"),
      },
      {
        label: "Corporate and bulk purchases",
        href: formatHref("Corporate and bulk purchases"),
      },
      { label: "Report a Product", href: formatHref("Report a Product") },
      {
        label: "Ship your package anywhere in Nigeria",
        href: formatHref("Ship your package anywhere in Nigeria"),
      },
      {
        label: "Dispute Resolution Policy",
        href: formatHref("Dispute Resolution Policy"),
      },
      {
        label: "Returns and Refunds Policy",
        href: formatHref("Returns and Refunds Policy"),
      },
    ],
  },
  {
    ...
    links: [
      ...
      { label: "Store Express", href: formatHref("Store Express") },
      {
        ...
        href: formatHref("Terms and Conditions"),
      },
  ...
  },
  {
    ...
    links: [
      { label: "Sell on Store", href: formatHref("Sell on Store") },
      {
        ...
        href: formatHref("Become a Sales Consultant"),
      },
      {
        label: "Become a Logistics Service Partner",
        href: formatHref("Become a Logistics Service Partner"),
      },
      {
        label: "Join the Store DA Academy",
        href: formatHref("Join the Store DA Academy"),
      },
      {
        label: "Join the Store KOL Program",
        href: formatHref("Join the Store KOL Program"),
      },
    ],
  },
  {
